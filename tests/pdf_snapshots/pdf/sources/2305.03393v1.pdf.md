...
Maksym Lysak [0000 − 0002 − 3723 − 6960] , Ahmed Nassar [0000 − 0002 − 9468 − 0822] Nikolaos Livathinos [0000 − 0001 − 8513 − 3491] , Christoph Auer [0000 − 0001 − 5761 − 0422] , [0000 0002 8088 0823] , and Peter Staar − − −
...
|              |          |          |        | TEDs    |       |           |       | Inference   |      |
|--------------|----------|----------|--------|---------|-------|-----------|-------|-------------|------|
|              | Data set | Language |        |         |       | mAP(0.75) |       | time (secs) |      |
|              |          |          | simple | complex | all   |           |       |             |      |
|              |          | OTSL     | 0.965  | 0.934   | 0.955 |           | 0.88  |             | 2.73 |
| PubTabNet    |          |          |        |         |       |           |       |             |      |
|              |          | HTML     | 0.969  | 0.927   | 0.955 |           | 0.857 |             | 5.39 |
