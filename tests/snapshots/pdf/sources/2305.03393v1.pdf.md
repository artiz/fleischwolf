...
[0000 0002 3723 6960] [0000 0002 9468 0822] Maksym Lysak , Ahmed Nassar , Nikolaos Livathinos [0000 0001 8513 3491] , Christoph Auer [0000 0001 5761 0422] , and Peter Staar [0000 0002 8088 0823]
...
Fig. 5. The OTSL model produces more accurate bounding boxes with less overlap (E) than the HTML model (D), when predicting the structure of a sparse table (A), at twice the inference speed because of shorter sequence length (B),(C). "PMC2807444\_006\_00.png" PubTabNet. μ μ
